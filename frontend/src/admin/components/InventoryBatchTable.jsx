import InventoryBatchRow from './InventoryBatchRow.jsx';

export default function InventoryBatchTable({
  rows,
  selectedIds,
  activeId,
  onToggleSelect,
        ...
        <table className="min-w-full text-left text-sm">
          <thead className="sticky top-0 z-10 bg-slate-50 text-xs font-black uppercase tracking-[0.16em] text-slate-500 dark:bg-slate-950 dark:text-slate-400">
            <tr>
              ...
              {['SKU', 'Product', 'Warehouse', 'Available', 'Incoming', 'Damaged', 'Freshness', 'Expiry', 'Actions'].map((label) => (
