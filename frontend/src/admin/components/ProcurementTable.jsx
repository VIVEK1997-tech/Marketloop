import ProcurementRow from './ProcurementRow.jsx';
        ...
        <table className="min-w-full text-left text-sm">
          <thead className="sticky top-0 z-10 bg-slate-50 text-xs font-black uppercase tracking-[0.16em] text-slate-500 dark:bg-slate-950 dark:text-slate-400">
            <tr>
              ...
              {['Procurement ID', 'Supplier', 'Request', 'Status', 'Quantity Plan', 'Expected vs Actual', 'Quality Score', 'Rejection Rate', 'Actions'].map((label) => (
