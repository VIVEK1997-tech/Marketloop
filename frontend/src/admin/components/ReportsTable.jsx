...
export default function ReportsTable({ rows, selectedIds, activeId, onToggleSelect, onToggleSelectPage, onOpen, onAction }) {
        ...
        <table className="min-w-full text-left text-sm">
          <thead className="sticky top-0 z-10 bg-slate-50 text-xs font-black uppercase tracking-[0.16em] text-slate-500 dark:bg-slate-950 dark:text-slate-400">
            <tr>
              ...
              {['Report', 'Formats', 'Last Run', 'Status', 'Actions'].map((label) => (
